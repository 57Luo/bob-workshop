...
系統預設包含高雄捷運紅線與橘線完整車站資料：

### 🔴 紅線 (Red Line)
RK1 岡山車站 → R24 岡山高醫 → R23 橋頭火車站 → R22A 橋頭糖廠 → R22 青埔 → R21 都會公園 → R20 後勁 → R19 楠梓科技園區 → R18 油廠國小 → R17 世運 → R16 左營（高鐵） → R15 生態園區 → R14 巨蛋 → R13 凹子底 → R12 後驛 → R11 高雄車站 → R9 中央公園 → R8 三多商圈 → R7 獅甲 → R6 凱旋 → R5 前鎮高中 → R4A 草衙 → R4 高雄國際機場 → R3 小港

### 🟠 橘線 (Orange Line)
OT1 大寮 → O14 鳳山國中 → O13 大東 → O12 鳳山 → O11 鳳山西站 (高雄市議會) → O10 衛武營 → O9 苓雅運動園區 → O8 五塊厝 → O7 文化中心 → O6 信義國小 → O4 前金 → O2 鹽埕埔 → O1 哈瑪星
